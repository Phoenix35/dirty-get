/*
    dirty-get is a simple node.js package that resolves the FULL body of an HTTP GET response
...
/**
 * Fully consumes an HTTP response stream from a GET request and resolves the body.
